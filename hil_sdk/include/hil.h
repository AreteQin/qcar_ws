...
typedef enum tag_hil_double_property
{
    ...
    /* QArm (USB and Mini) specific double properties */
    PROPERTY_DOUBLE_QARM_P_GAIN_YAW = PROPERTY_DOUBLE_PRODUCT_SPECIFIC,
    PROPERTY_DOUBLE_QARM_P_GAIN_SHOULDER,
    PROPERTY_DOUBLE_QARM_P_GAIN_ELBOW,
    PROPERTY_DOUBLE_QARM_P_GAIN_WRIST,
    PROPERTY_DOUBLE_QARM_P_GAIN_GRIPPER,
    PROPERTY_DOUBLE_QARM_I_GAIN_YAW,
    PROPERTY_DOUBLE_QARM_I_GAIN_SHOULDER,
    PROPERTY_DOUBLE_QARM_I_GAIN_ELBOW,
    PROPERTY_DOUBLE_QARM_I_GAIN_WRIST,
    PROPERTY_DOUBLE_QARM_I_GAIN_GRIPPER,
    PROPERTY_DOUBLE_QARM_D_GAIN_YAW,
    PROPERTY_DOUBLE_QARM_D_GAIN_SHOULDER,
    PROPERTY_DOUBLE_QARM_D_GAIN_ELBOW,
    PROPERTY_DOUBLE_QARM_D_GAIN_WRIST,
    PROPERTY_DOUBLE_QARM_D_GAIN_GRIPPER,
    PROPERTY_DOUBLE_QARM_FF_VEL_GAIN_YAW,
    PROPERTY_DOUBLE_QARM_FF_VEL_GAIN_SHOULDER,
    PROPERTY_DOUBLE_QARM_FF_VEL_GAIN_ELBOW,
    PROPERTY_DOUBLE_QARM_FF_VEL_GAIN_WRIST,
    PROPERTY_DOUBLE_QARM_FF_VEL_GAIN_GRIPPER,
    PROPERTY_DOUBLE_QARM_FF_ACC_GAIN_YAW,
    PROPERTY_DOUBLE_QARM_FF_ACC_GAIN_SHOULDER,
    PROPERTY_DOUBLE_QARM_FF_ACC_GAIN_ELBOW,
    PROPERTY_DOUBLE_QARM_FF_ACC_GAIN_WRIST,    
    PROPERTY_DOUBLE_QARM_FF_ACC_GAIN_GRIPPER
...
typedef enum tag_esc_protocol
{
    ESC_PROTOCOL_INVALID,

    ESC_PROTOCOL_STANDARD_PWM,  /* 1-2ms, 20ms period */
    ESC_PROTOCOL_ONESHOT125,    /* OneShot125: 125-250us, 500us period */
    ESC_PROTOCOL_ONESHOT42,     /* OneShot42 : 42-84us, 168us period */
    ESC_PROTOCOL_MULTISHOT,     /* 5us - 25us, 50us period */
    ESC_PROTOCOL_DSHOT,         /* DShot150, DShot300, DShot600, DShot1200, DShot2400, DShot3600 where DShot<n>, <n> = bit rate in kHz */

    NUMBER_OF_ESC_PROTOCOLS
} t_esc_protocol;

typedef enum tag_dshot_command
{
    DSHOT_COMMAND_DISARM,               /* Disarm.The motor will stop */
    DSHOT_COMMAND_BEEP_LOW,             /* Make a low frequency beep */
    DSHOT_COMMAND_BEEP_MEDIUM_LOW,      /* Make a medium - low frequency beep */
    DSHOT_COMMAND_BEEP_MEDIUM,          /* Make a medium frequency beep */
    DSHOT_COMMAND_BEEP_MEDIUM_HIGH,     /* Make a medium - high frequency beep */
    DSHOT_COMMAND_BEEP_HIGH,            /* Make a high frequency beep */
    DSHOT_COMMAND_ESC_INFORMATION,      /* Request information about the ESC(firmware version, serial numberand settings over telemetry wire) */
    DSHOT_COMMAND_ROTATE,               /* Rotate in one direction */
    DSHOT_COMMAND_ROTATE_OTHER,         /* Rotate in the other direction */
    DSHOT_COMMAND_3D_MODE_OFF,          /* 3D mode off */
    DSHOT_COMMAND_3D_MODE_ON,           /* 3D mode on */
    DSHOT_COMMAND_ESC_SETTINGS,         /* ESC settings request(saved over telemetry wire) */
    DSHOT_COMMAND_SAVE_SETTINGS,        /* Save settings */

    DSHOT_COMMAND_ROTATE_NORMAL = 20,   /* Rotate in the normal direction(determined by ROTATE or ROTATE_OTHER command) */
    DSHOT_COMMAND_ROTATE_REVERSE,       /* Rotate in the reverse direction(normal direction determined by ROTATE or ROTATE_OTHER command) */
    DSHOT_COMMAND_LED0_ON,              /* LED 0 on */
    DSHOT_COMMAND_LED1_ON,              /* LED 1 on */
    DSHOT_COMMAND_LED2_ON,              /* LED 2 on */
    DSHOT_COMMAND_LED3_ON,              /* LED 3 on */
    DSHOT_COMMAND_LED0_OFF,             /* LED 0 off */
    DSHOT_COMMAND_LED1_OFF,             /* LED 1 off */
    DSHOT_COMMAND_LED2_OFF,             /* LED 2 off */
    DSHOT_COMMAND_LED3_OFF,             /* LED 3 off */
    DSHOT_COMMAND_AUDIO_ON_OFF,         /* Audio stream on / off */
    DSHOT_COMMAND_SILENT_MODE,          /* Silent mode on / off */

    DSHOT_COMMAND_ARMED = 48            /* Armed(normal operation) */
} t_dshot_command;
