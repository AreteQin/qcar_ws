...
#include "quanser_image_stream.h"
...
typedef enum tag_image_format
{
    ...
    IMAGE_FORMAT_STREAM,                    /* image stream (image data type is ignored in this case) */
 ...
 *
 * If the image format is IMAGE_FORMAT_STREAM then the data is stored in an internal platform-specific format that is optimized
 * for the platform. In this case, pass a pointer to a t_image_stream handle as the image_data.
 */
EXTERN t_error
...
/*
** Get the specifications of the image passed to video_capture_open. Any parameter that is NULL will
** not be retrieved.
*/
EXTERN t_error
video_capture_get_image_specification(t_video_capture capture, t_double * frame_rate, t_uint * frame_width, t_uint * frame_height, 
...
/*
** Get the specifications of the image passed to video_display_attach. Any parameter that is NULL will
** not be retrieved.
*/
EXTERN t_error
video_display_get_image_specification(t_video_display display, t_double* frame_rate, t_uint* frame_width, t_uint* frame_height,
    t_image_format* format, t_image_data_type* data_type);
