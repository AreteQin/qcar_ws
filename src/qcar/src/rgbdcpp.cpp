...
int main(int argc, char **argv)
{
	...
	ros::Publisher rgbd_color_pub = n.advertise<sensor_msgs::Image>("/qcar_obsolete/rgbd_color", 10);
	ros::Publisher rgbd_depth_pub = n.advertise<sensor_msgs::Image>("/qcar_obsolete/rgbd_depth", 10);
